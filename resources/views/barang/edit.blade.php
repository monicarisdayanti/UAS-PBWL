            ...
            <form action="/barang/{{ $dataBarang->id }}" method="post">
                    ...
                    <div class="col-md-5">
                        ...
                        <select name="id_supplier" id="id_supplier" class="form-select">
                            @foreach ($dataUser as $rowUser)
                                @if (old('id_supplier', $dataBarang->id) == $rowUser->id)
                ...
                <div class="row mb-3">
                    <div class="col-md-2">
                        ...
                        <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" id="kode" placeholder="Input kode" value="{{ old('kode', $dataBarang->kode) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Input nama" value="{{ old('nama', $dataBarang->nama) }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-5">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Input keterangan">{{ old('keterangan', $dataBarang->keterangan) }}</textarea>
                    </div>
                </div>
