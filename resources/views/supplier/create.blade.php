            ...
            <form action="/supplier" method="post">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <textarea name="alamat" id="alamat" class="form-control" placeholder="Input alamat">{{ old('alamat') }}</textarea>
                    </div>
                </div>
                <div class="row mb-3 mt-5">
                    <div class="col-md-6">
                        <label for="hp" class="form-label">No HP</label>
                        <input type="text" name="hp" class="form-control" id="hp" placeholder="Input no hp" value="{{ old('hp') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="pos" class="form-label">Kode Pos</label>
                        <input type="text" name="pos" class="form-control" id="pos" placeholder="Input kode pos" value="{{ old('pos') }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
