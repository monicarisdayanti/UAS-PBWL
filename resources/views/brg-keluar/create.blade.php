            ...
            <form action="/barang-keluar" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="number" min="0" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" placeholder="Input jumlah" value="{{ old('jumlah') }}" required>
                        @error('jumlah')
